						...
						<div class="card">
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between">
                                    ...
                                    <a class="modal-effect btn btn-success" href="{{ route('ExportInvoices') }}"><i class="fas fa-file-download"></i>&nbsp;تصدير اكسيل</a>
                                </div>
							</div>
							<div class="card-body">
										...
										<tbody>
                                            @foreach ($invoices as $invoice)
                                                <tr class="text-center">
                                                    ...
                                                    <td>
                                                        <a href="{{ route('categories.show', $invoice->category->id) }}">{{$invoice->category->category_name}}</a>
                                                    </td>
