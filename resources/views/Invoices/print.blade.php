...
@endsection
@section('title')
     طباعة الفاتورة {{$invoice->id}}
@endsection
@section('page-header')
    <!-- breadcrumb -->
    <div class="breadcrumb-header justify-content-between" id="none">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الفواتير</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ طباعة الفاتورة {{ $invoice->id }}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                        ...
                        <div class="row mg-t-20">
                            <div class="col-md">
                                ...
                                <p class="invoice-info-row"><span>القسم</span>
                                    <span>{{ $invoice->category->category_name }}</span></p>
                            </div>
                        </div>
                            ...
                            <table class="table table-invoice border text-md-nowrap mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tx-center" colspan="2"> {{ number_format($total, 2) }}</td>
                                    </tr>
                                    <tr>
                                        <td class="tx-center">نسبة الضريبة</td>
                                        <td class="tx-center" colspan="2">{{ $invoice->rat_vat }}</td>
                                    </tr>
                                    <tr>
                                        <td class="tx-center">قيمة الخصم</td>
                                        <td class="tx-center" colspan="2"> {{ number_format($invoice->discount, 2) }}</td>
