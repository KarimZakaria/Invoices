...
@endsection
@section('title')
    تغير حالة الدفع فاتورة {{$invoice->id}}
@stop
@section('page-header')
    <!-- breadcrumb -->
...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('updateStatus', $invoice->id) }}" method="post" autocomplete="off">
                        @csrf
                        {{-- 1 --}}
                        <div class="row">
                            <div class="col">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="category" class="form-control " onclick="console.log($(this).val())"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select name="rat_vat" id="rat_vat" class="form-control" onchange="myFunction()" readonly>
                                    <!--placeholder-->
                                    <option value=" {{ $invoice->rat_vat }}">
                                        {{ $invoice->rat_vat }}
                                </select>
                            </div>
                        ...
                        @elseif($invoice->status_value == 1)
                            <h5 class="text-center text-success">تم سداد الفاتوره كليا</h5>
                        @elseif($invoice->status_value == 3)
                            <h5 class="text-center text-primary mt-2">تم دفع الفاتوره جزئيا</h5>
                            <div class="row">
                                <div class="col">
                                    <label for="exampleTextarea">حالة الدفع</label>
                                    <select class="form-control" id="status" name="status" required>
