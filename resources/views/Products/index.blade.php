                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="d-flex justify-content-between">
                            ...
                            data-toggle="modal" href="#exampleModal"><i class="fa fa-plus ml-2"></i>اضافة منتج</a>
                            ...
                            <table id="example1" class="table key-buttons text-md-nowrap" data-page-length="50">
                                <thead>
                                    <tr class="text-center">
                                        <th class="border-bottom-0">الترقيم</th>
                                ...
                                <tbody>
                                    @foreach ($products as $product)
                                        <tr class="text-center">
                                            ...
                                            <td> <a href="{{route('categories.show', $product->category->id)}}">{{ $product->category->category_name ?? '' }}</a></td>
                                            <td>
