			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						<a class="" href="{{ route('UserProfile', Auth::user()->id) }}">
							<img alt="user-img" class="avatar avatar-xl brround" src="{{asset('profile/Images/'. Auth::user()->image) }}"><span class="avatar-status profile-status bg-green"></span>
						</a>
						<div class="user-info">
				...
				<ul class="side-menu">
                    ...
                    @can('الفواتير')
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                @can('قائمة الفواتير')
                                    <li><a class="slide-item" href="{{ route('UserInvoices', Auth::user()->id) }}">قائمة الفواتير</a></li>
                                @endcan
                                @can('الفواتير المدفوعة')
                                    <li><a class="slide-item" href="{{ route('PaidInvoices') }}">المدفوعة</a></li>
                                @endcan
                                @can('الفواتير الغير مدفوعة')
                                    <li><a class="slide-item" href="{{ route('unPaidInvoices') }}">غير المدفوعة</a></li>
                                @endcan
                                @can('الفواتير المدفوعة جزئيا')
                                    <li><a class="slide-item" href="{{ route('PartialPaidInvoices') }}">المدفوعة جزئيا</a></li>
                                @endcan
                                @can('ارشيف الفواتير')
                                    <li><a class="slide-item" href="{{ route('invoices.trashed') }}">المحذوفة جزئيا</a></li>
                                @endcan
                            </ul>
                        </li>
                    @endcan
                    @can('التقارير')
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                ...
                                @endcan
                                @can('تقرير العملاء')
                                    <li><a class="slide-item" href="{{ route('CategoryReports') }}">تقارير بالاقسام</a></li>
                                    <li><a class="slide-item" href="{{ route('AllInvoices') }}"> بالفواتير والاقسام</a></li>
                                @endcan
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            ...
                            @endcan
                                <li><a class="slide-item" href="{{ route('products.trashed') }}">المنتجات المحذوفة</a></li>
                        </ul>
                    </li>
                    @endcan
				</ul>
